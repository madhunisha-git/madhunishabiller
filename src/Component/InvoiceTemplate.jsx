  ...
  return (
    <div style={{ padding: 2, background: "#fff", color: "#000", fontFamily: "Arial, sans-serif", boxSizing: "border-box" }}>
      <div style={{ border: "1px solid #000" }}>
        {/* HEADER */}
        <div style={{ display: "flex", alignItems: "center", borderBottom: "1px double #000", padding: "10px 20px" }}>
        ...
        <div style={{ display: "flex", borderBottom: "1px solid #000" }}>
          ...
          <div style={{ width: 383, padding: 12, fontSize: 12 }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <tbody>
                <tr><td>Total</td><td style={{ textAlign: "right" }}>{subtotal.toFixed(2)}</td></tr>
                <tr><td>Taxable Value</td><td style={{ textAlign: "right" }}>{taxableValue.toFixed(2)}</td></tr>
                {!isIGST && (
                  <>
                ...
                {isIGST && <tr><td>IGST 18%</td><td style={{ textAlign: "right" }}>{igst.toFixed(2)}</td></tr>}
        ...
        {/* TERMS + SIGN - Signature moved to right corner */}
        <div style={{ display: "flex" }}>
          ...
          <div style={{ width: 383, padding: 12, fontSize: 14, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            ...
            <div style={{ marginTop: 20, width: 220, textAlign: "center" }}>
            ...
            <div style={{ marginTop: 8, fontWeight: 700 }}>Partner / Manager</div>
            </div>
        </div>
      </div>
    </div>
